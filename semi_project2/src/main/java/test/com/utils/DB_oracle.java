...
public interface DB_oracle {
	...
	String SQL_ACTIVITY_NOTICE = "select distinct activity.activity_id, activity_user.activity_user_id,name,activity_date,"
	...
	String SQL_RECOMMEND_ACTIVITY_LOCATION_SELECT_ALL = "select distinct activity_id,name,activity_date,activity_time,activity_location,current_people,image_url,total_people from recommend_activity_view "
			...
			+ "and current_people<total_people";
	String SQL_IMMINENT_ACTIVITY_SELECT_ALL = "select distinct activity_id,name,activity_date,activity_time,activity_location,"
			+ "current_people,image_url,total_people, "
